...
The AI Prototype turns out to work better than I imagined. I put in some sample codes and the truth table of the XOR-AND into chat-GPT 4 free trial. It's outputs can't be synthesized.
...
A recent article I read talks about embedded AI which is described as a cheap innovative AI solutation that can do more than cloud-based AI.
Citations: Yuanyuan, F. (2021, July 1). What Is Embedded AI (EAI)? Why Do We Need EAI? - Huawei. Info.support.huawei.com. https://info.support.huawei.com/info-finder/encyclopedia/en/EAI.html
